 ...
 * @endcode
 */
$settings['hash_salt'] = 'hWDhW2-HaUrgxu8ZDXwmqKl24MoWbCWirUNL7IVLNl0mpWzOxT3MtCSeXaDKezCDs6aTPJxXqg';
...
$databases['default']['default'] = [
  'database' => 'mspp_drupal',
  'username' => 'root',
  'password' => 'root',
  'host' => 'localhost',
  'port' => '3306',   // confirm from MAMP
...
$settings['config_sync_directory'] = 'sites/default/files/config_-lcYXKhiLIohfOcufISzV7wwVJFelqpjXfP83nWyV-iRbMYh36nKAU38ad7pYW35W5Bqm0a5-g/sync';

$settings['environment'] = 'dev'; // or 'dev', 'local', etc.
